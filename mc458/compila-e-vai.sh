...
#Gera os arquivos .out e um arquivo diff.txt na pasta dos testes que tem o diff 
#cada teste
...
allright=1            #flag para ver se todos os resultados foram corretos 

cd $testsPath
echo "" > $diffFile   #cria ou reseta o arquivo de diff na pasta de testes
